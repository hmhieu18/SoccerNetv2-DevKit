...
def main(args):
    if args.load_once:
        from dataset_1 import SoccerNetClips, SoccerNetClipsTesting, SoccerNetClipsTesting2  # ,SoccerNetClipsOld
    else:
    ...
    dataset_Test = SoccerNetClipsTesting2(visual_path=args.SoccerNet_path, audio_path=args.audio_path, features=args.features, split=args.split_test,
