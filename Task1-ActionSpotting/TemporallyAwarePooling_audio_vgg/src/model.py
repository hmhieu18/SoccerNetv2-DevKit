...
class Model(nn.Module):
    def __init__(self, weights=None, input_size=512, audio_input_size=512, num_classes=17, vocab_size=64, window_size=15, framerate=2, pool="NetVLAD"):
        """
        ...
        if not self.audio_input_size == 512:
            self.audio_feature_extractor = nn.Linear(self.audio_input_size, 512)
            audio_input_size = 512
            self.audio_input_size = 512
